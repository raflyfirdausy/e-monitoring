          ...
          <div class="col-md-8"> 
              ...
              <div class="box-body">  
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody> 
                        <?php 
                            $query = mysqli_query($conn,"select * from m_induk");
                            $no = 1;
                            while ($data = mysqli_fetch_array($query)) {?>
                                <tr>
                                    ...
                                    <td>  
                                      ...
                                      <a onclick="return confirm('Anda yakin akan menghapus data?')" href="m_induk_del.php?id=<?php echo $data['id']; ?>" class="btn btn-danger m-r-5 active" ><span class="active-visible"><i class="fa fa-trash-o"></i> Hapus</span></a>
                                    </td>   
                                </tr>
                        <?php $no++; } ?>
                    </tbody>
