      ...
      <section class="content">  
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Alat Uji Master</h3>
          </div>
          <div class="box-body">
            <div class="col-md-4"> 
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="col-lg-12"> 
                  <label>Kode</label>
                  <input type="text" class="form-control pull-right" id="kode" name="kode" placeholder="kode....">
                </div>
              </div> 
              <div class="form-group">
                <div class="col-lg-12"> 
          ...
          <div class="col-md-8"> 
              ...
              <div class="box-header with-border">
                ...
                <div align="right"><a href="printbarcode.php" class="btn btn-success" target="_blank" ><i class="fa fa-print"></i> cetak barcode</a></div>
                        ...
                        <?php 
                            ...
                            while ($data = mysqli_fetch_array($query)) {?>
                                <tr>
                                    ...
                                    <td> 
                                      <a href="m_alat_aksesories.php?kode=<?=$data['kode']?>" target="_blank"><label class="label btn-info"> Input Aksesories</label></a> 
