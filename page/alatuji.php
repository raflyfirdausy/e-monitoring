      ...
      <div class="container">
        ...
        <div class="section-wrapper">    
          ...
          <div class="col-lg-4">  
            ...
            <form action="alatuji.php" method="get">
              <div class="form-layout form-layout-5">
                <div class="row">
                  <label class="col-sm-4 form-control-label"><span class="tx-danger">*</span> Kode:</label>
                  <div class="col-lg-8 mg-t-20 mg-lg-t-0">
		              <select class="form-control select2-show-search" data-placeholder="Pilih..." id="kode" name="kode">
		                <option label="Choose one"></option>
		                <?php  
		                	$sql = mysqli_query($conn,"SELECT * FROM m_namaalat"); 
                ...
                <div class="row mg-t-30">
                  <div class="col-sm-8 mg-l-auto">
                    <div class="form-layout-footer">
                      ...
                      <a href="alatuji.php" class="btn btn-secondary bd-0">Refresh</a>
          ...
          <?php 
                if(isset($_GET['kode'])){ 
                  ...
                  $query = mysqli_query($conn,"INSERT INTO m_alatuji (id,kode,nama,noseri,merk,tipe,jumlah) VALUES ('','".$kode."','".$nama."','".$noseri."','".$merk."','".$tipe."','".$jumlah."')");  
                  echo "
          ...
          <div class="responsive">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                 <?php  
                  $query = mysqli_query($conn,"select * from m_alatuji");
                  $no = 1;
