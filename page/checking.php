      ...
      <section class="content">  
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Form Checking</h3>
          </div>
          <div class="box-body">
            <div class="col-md-12">   
            <div class="col-md-5"> 
            ...
            <div class="col-md-7">
                <div class="box box-primary box-solid">
                  <div class="box-header with-border">
                    <h3 class="box-title">Input Hasil Pengerjaan</h3>
                  ...
                  <!-- /.box-header -->
                  <div class="box-body"> 
                      <form action="checking_save.php" method="post" class="form-horizontal" enctype="multipart/form-data">  
                        ...
                        <div class="form-group">
                          <div class="col-lg-12"> 
                             <div class="col-lg-12"> 
                             <label>Catatan</label> 
                             <textarea rows="4" cols="50" class="form-control" name="catatan" id="catatan" placeholder="Tulis Catatan here..."></textarea>
                             </div>
                          </div>
                        </div>
                        <div class="form-group">
