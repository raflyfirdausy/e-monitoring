          ...
          <li class="nav-item with-sub ">
            ...
            <div class="sub-item">
              <ul>
                ...
                <li><a href="mnamaalat.php">Alat Uji</a></li>  
        ...
        <div class="section-wrapper">    
              ...
              <div class="form-layout form-layout-5">
                <div class="row">
                  ...
                  <div class="col-sm-4 mg-t-10 mg-sm-t-0">
                    <input type="date" class="form-control" placeholder="Masukan Kode" id="tanggal" name="tanggal" value="<?=date('Y/m/d')?>">
                  </div>
                </div><!-- row -->
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Pekerjaan:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan Nama" id="pekerjaan" name="pekerjaan">
                  </div>
                </div>
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Lokasi Pekerjaan:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan No. Seri" id="lokasi" name="lokasi">
                  </div>
                </div> 
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Pengawas Pekerjaan:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan No. Seri" id="pengawaspekerjaan" name="pengawaspekerjaan">
                  </div>
                </div> 
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Pengawas K3:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan No. Seri" id="pengawask3" name="pengawask3">
                  </div>
                </div> 
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Penanggung Jawab Alat:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan No. Seri" id="penanggungjawab" name="penanggungjawab">
                  </div>  
                </div> 
                <div class="row mg-t-20">
                  <label class="col-sm-3 form-control-label">Scan Barcode:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Masukan No. Seri" id="barcode" name="barcode">
                  </div>  
                </div> 
          ...
          <?php 
                if(isset($_GET['barcode'])){ 
                  ...
                  $lokasi = $_GET['lokasi'];
                  $pengawaspekerjaan = $_GET['pengawaspekerjaan'];
                  $pengawask3 = $_GET['pengawask3'];
                  $penanggungjawab = $_GET['penanggungjawab'];
                  $barcode = $_GET['barcode'];

                  $query = mysqli_query($conn,"INSERT INTO trs_peminjaman (id,idalat,tgltransaksi,pekerjaan,lokasi,pengawas,k3,penanggungjawab) VALUES ('','".$barcode."','".$tanggal."','".$pekerjaan."','".$lokasi."','".$pengawaspekerjaan."','".$pengawask3."','".$penanggungjawab."')");  
                  echo "
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                 <?php  
                  $query = mysqli_query($conn,"select A.*,B.nama,B.noseri,B.merk,B.tipe,B.jumlah
                                               from trs_peminjaman a
                                               left join mnamaalat as B ON A.idalat = B.kode
                                               left join m_alatuji as C ON A.idalat = C.kode");
                  $no = 1;
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" class="btn btn-primary btn-icon rounded-circle"><div><i class="fa fa-search"></i></div></a>
