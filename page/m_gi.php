      ...
      <section class="content">  
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">GI (Gardu Induk)</h3>
          </div>
          <div class="box-body">
            <div class="col-md-4"> 
                ...
                <div class="col-lg-12"> 
                  <label>Kode</label>
                   <select class="form-control select2" style="width: 100%;" name="kode" id="kode">
                    <option value="">Pilih Nama UTLG..........</option>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr class="headings">
                            ...
                            <th width="10%">Nama GI</th> 
                            <th width="10%">Aksi</th>
                        </tr>  
                    </thead>
                    <tbody> 
                        <?php 
                            $query = mysqli_query($conn,"select * from m_gi");
                            $no = 1;
                            while ($data = mysqli_fetch_array($query)) {?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?=@$data['id_utlg']; ?></td>
                                    <td><?php echo $data['nama_gi']; ?></td>
