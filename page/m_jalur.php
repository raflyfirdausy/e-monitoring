      ...
      <section class="content">  
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Jalur (bye)</h3>
          </div>
          <div class="box-body">
            <div class="col-md-4"> 
                ...
                <div class="col-lg-12"> 
                  <label>Kode GI</label>
                   <select class="form-control select2" style="width: 100%;" name="kode" id="kode">
                    <option value="">Pilih Nama GI..........</option>
                    <?php $query = mysqli_query($conn,"select * from m_gi");
                          while ($data = mysqli_fetch_array($query)) {?>
                    <option value="<?=$data['id']?>"><?=$data['nama_gi']?></option>
                    <?php }?>
                  </select>
                </div>
              </div> 
          ...
          <div class="col-md-8"> 
              ...
              <div class="box-body">  
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody> 
                        <?php 
                            $query = mysqli_query($conn,"select * from m_jalur");
                            $no = 1;
                            while ($data = mysqli_fetch_array($query)) {?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?=@$data['nama_jalur']; ?></td>
                                    <td><?php echo $data['id_gi']; ?></td>
